...
public class MoveElevatorToL0 extends Command {
  /** Creates a new MoveElevatorToL4. */
  CoralDeliverySubsystem coralSubsystem;

  public MoveElevatorToL0(CoralDeliverySubsystem coralSubsystem) {
  ...
  public void initialize() {
    coralSubsystem.setElevatorLoadPosition();
  }
  ...
  public boolean isFinished() {
    if((coralSubsystem.getElevatorPosition() <= (CoralDeliveryCfg.ELEVATOR_LOAD_POSITION+1))&&
       (coralSubsystem.getPivotPosition() <= (CoralDeliveryCfg.PIVOT_LOAD_POSITION+1))){
          return true;
    }
    return false;
  }
